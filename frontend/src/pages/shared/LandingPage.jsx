...
import lgo from '../../assets/hexagonlogo1.png'
    ...
    <div className={s.bgMain}>
            ...
            <div className={s.verifiedBadge}> 
              ...
              <div>
                ...
                <p className={s.badgeText}>
                  Inspect by our professional team
                </p>
        ...
        <div className={s.container}>
          ...
          <div className={s.categoryGrid}>
            {categories.map((cat, idx)=>(
              <div key={idx} className={s.categoryCard} onClick={()=>
        ...
        <div className={s.featuresContainer}>
          <div className={s.featuresList}>
            {features.map((f, idx)=>(
              <div
              key={idx}
              className={s.featureCard} style={{animationDelay: `${idx * 0.1}s`}}
              >
      ...
      <section id="process" className={s.processSection}>
        <div className={s.container}>
          <div className={s.processHeader}>
            <div className={s.processBadge}>How It Works</div>
      ...
      <footer className={s.footer}>
        <div className={s.container}>
          <div className={s.footerMainGrid}>
            <div className={s.footerBrand}>
              ...
              <p className={s.brandDesc}>
                ...
                premium real estate gloabally. we make property hunting seamless.
              </p>
          ...
          {/* column 4 */}
          <div>
            <h4 className={s.footerHeading}>Newsletter
            </h4>
            <p className={s.newsletterDesc}>Subscribe to get the latest listings and market insights
              directly in your inbox
            </p>
            <div className={s.newsletterInputWrapper}>
              <input type="email" placeholder='Enter Your Email' className={s.newsletterInput}></input>
          ...
          <div className={s.bottomBar}>
            ...
            <div className={s.designCredit}>
              <img src={lgo} alt='logo' className={s.designLogo}></img>
              <span className="text-text-muted">Designed By</span>
              <a href="https://github.com/PrincySingh04"
              target="_blank"
              className={s.designLink}>
                Designed By Princy Singh
